...
IPoseBasedCostCalculator::IPoseBasedCostCalculator(Logger *parentLogger)
    : IPoseBasedCostCalculator(__FUNCTION__, parentLogger)
{
    m_gridmap_field.logger().setParent(&logger());
    m_gridmap_restrictedAreas.logger().setParent(&logger());
    m_gridmap_visits.logger().setParent(&logger());
}
...
IPoseBasedCostCalculator::IPoseBasedCostCalculator(const std::string childName, Logger *parentLogger)
...
PBCC_timeOpt::PBCC_timeOpt(Logger *parentLogger)
    : IPoseBasedCostCalculator(__FUNCTION__, parentLogger)
{
