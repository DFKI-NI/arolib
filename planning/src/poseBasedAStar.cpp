...
#include "arolib/planning/poseBasedAStar.hpp"
...
PoseBasedAstar::PoseBasedAstar(const PoseBasedAstar::Settings &settings, Logger *_logger)
                                              ...
                                              std::shared_ptr<IPoseBasedCostCalculator> costCalculator)
{
    ...
    PoseBasedGraph minimizeGraph(&m_logger);
    ...
    PoseBasedAstar astar(settings2, &m_logger);
    auto params2 = params;
