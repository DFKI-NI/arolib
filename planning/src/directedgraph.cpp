    ...
    LoggingComponent(logLevel, __FUNCTION__)
{
    ...
    m_meta.maxTrackId_IF = std::numeric_limits<int>::lowest();
    m_meta.minTrackId_IF = std::numeric_limits<int>::max();
    m_meta.maxTrackId_HL = std::numeric_limits<int>::lowest();
    m_meta.minTrackId_HL = std::numeric_limits<int>::max();
...
void Graph::saveVisitSchedule(const std::string &filename, char sep) const
{
...
void Graph::saveVerticesInfo(const std::string &filename, char sep) const
{
    std::ofstream out(filename);
    if(!out.is_open())
        return;
...
int Graph::maxTrackId_IF() const {return m_meta.maxTrackId_IF;}

int Graph::minTrackId_IF() const {return m_meta.minTrackId_IF;}

int Graph::maxTrackId_HL() const {return m_meta.maxTrackId_HL;}

int Graph::minTrackId_HL() const {return m_meta.minTrackId_HL;}

std::map<Point, vertex_t> &Graph::HLpoint_vertex_map() {return m_meta.HLpoint_vertex_map;}

const std::map<Point, vertex_t> &Graph::HLpoint_vertex_map() const {return m_meta.HLpoint_vertex_map;}
...
std::vector<vertex_t> &Graph::HLProcessingVertices() {return m_meta.HLProcessingVertices;}

const std::vector<vertex_t> &Graph::HLProcessingVertices() const {return m_meta.HLProcessingVertices;}
