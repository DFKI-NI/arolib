...
public:
    ...
    */
    ...
    AstarPlan& add(const AstarPlan& other, bool removeFirstRoutePoint);
    ...
    std::vector< DirectedGraph::vertex_t > visited_vertices; /**< Visited vertices */
    std::vector< DirectedGraph::edge_t > visited_edges; /**< Visited edges */
