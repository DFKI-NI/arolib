...
public:
     ...
     */
    explicit IPoseBasedCostCalculator(std::shared_ptr<Logger> parentLogger = nullptr);
...
protected:
     ...
     * @param parentLogger Parent logger
     */
    explicit IPoseBasedCostCalculator(const std::string childName, std::shared_ptr<Logger> parentLogger = nullptr);
...
public:
     ...
     * @param parentLogger Parent logger
     */
    explicit PBCC_timeOpt(std::shared_ptr<Logger> parentLogger = nullptr);
